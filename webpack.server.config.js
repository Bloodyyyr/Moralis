...
const parts_minify = require("./webpack.parts-minify-server");
...
// PRODUCTION
          ...
          { from: "src/server", }, // Copy ressources from public folder to $APP_BUILD_DIR
